...
(function () {
    ...
    style.textContent = [
        ...
        '@media (hover: hover) and (pointer: fine){.st-chip:hover{border-color:#9ccfae;transform:translateY(-1px);}}',
        '.st-chip:active{transform:translateY(0) scale(0.97);}',
        ...
        '@media (hover: hover) and (pointer: fine){.st-rate .st-b-ok:hover{background:#eef8f2;border-color:#a8dcc2;color:#2f7d55;}}',
        '@media (hover: hover) and (pointer: fine){.st-rate .st-b-meh:hover{background:#fdf6e9;border-color:#e6cd97;color:#9a7326;}}',
        '@media (hover: hover) and (pointer: fine){.st-rate .st-b-no:hover{background:#fdeeee;border-color:#e8b2b2;color:#a85050;}}',
        ...
        '@media (hover: hover) and (pointer: fine){.st-rate .st-b-view:hover{background:#eefaf3;border-color:#8ed0ae;color:#2b6b46;}}',
        '.st-rate button:active{transform:scale(0.96);}',
